...
public enum Movement {
	...
	LIFTING_CLIMB_LEFT(UP_LEFT, STANDARD_MOVE_DURATION, new CompositeSpline(UP, LEFT)),
	LIFTING_CLIMB_RIGHT(UP_RIGHT, STANDARD_MOVE_DURATION, new CompositeSpline(UP, RIGHT)),
	...
	public static boolean isPull(Movement movement) {
		if (movement == null) {
			return false;
		}
		return movement.isPullMovement();
	}
